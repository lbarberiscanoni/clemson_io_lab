                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-3">
                            ...
                            <p>If you have questions about program admission requirements, please visit the Clemson Psychology Department website for more details.</p>
                        </div>
                        <div className="col-md-6">
                            <div className="row">
                            ...
                            <div className="row">
                                Current research projects funded by NASA and the
                                National Science Foundation involve investigating:

                                <ol>
                                    <li> Virtual and physically distributed teams </li>
                                    <li> Multicultural teams </li>
                                    <li> Collective/shared leadership </li>
                                    <li> Multiteam systems </li>
                                    <li> Team development intervention </li>
                                    <li> Director, Developing and Improving Globally Integrated Teamwork and Leadership (DIGITAL) Lab </li>
                                </ol>
                            </div>
                            <div className="row">
                                ...
                                <address>mshuffl@clemson.edu</address>
                            </div>
                        </div>
                        <div className="col-md-3"></div>
                    </div>
